    ...
    def on_draw(self):
        ...
        if self.me.life <= 0:
            ...
            for life in range(self.me.life):
                life_image = arcade.load_texture('ghalb.png')
                #life_image =arcade.load_texture(':resources:images/space_shooter/playerShip1_green.png')
                arcade.draw_lrwh_rectangle_textured(6 + life * 30, 5 , 20, 20 , life_image)
            
            arcade.draw_text(f'score: {self.me.score}', 680, 20, arcade.color.BLUE, 25)
